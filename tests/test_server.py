...
class StaticAppStructureTestCase(unittest.TestCase):
    ...
    def test_chat_history_is_chunked_lazy_and_unloaded_between_rooms(self) -> None:
        ...
        self.assertIn('typeof CHAT_MESSAGE_MEMORY_LIMIT === "number"', chat_script)
        self.assertIn('typeof CHAT_MESSAGE_ESTIMATED_HEIGHT === "number"', chat_virtual_script)
        self.assertIn('typeof CHAT_MESSAGE_PAGE_SIZE === "number"', app_script)
