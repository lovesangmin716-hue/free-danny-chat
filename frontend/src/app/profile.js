...
import { DEFAULT_PROFILE_PALETTE, IMAGE_DIMENSION_MAX, IMAGE_FALLBACK_TOTAL_PIXELS_MAX, IMAGE_TOTAL_PIXELS_MAX, PIXEL_SIDE, PROFILE_IMAGE_SIDE, PROFILE_IMAGE_SOURCE_BYTES_MAX, PROFILE_PALETTES, PROFILE_PALETTE_NAMES, PROFILE_PIXEL_COUNT, blankProfilePixels, cancelProfilePhotoButton, createAvatar, customColorButton, customPaletteColors, customPaletteCount, customPaletteEmpty, customProfileColor, getDisplayName, normalizeProfilePixels, palettePicker, pixelEditorGrid, pixelPalette, profileDisplayName, profileFriendCode, profilePaletteSelect, profilePhotoCrop, profilePhotoCropCanvas, profilePhotoInput, profilePhotoPreview, profilePhotoZoom, profilePhotoZoomValue, profilePixelStatus, profileSheet, registerCoreHooks, removeProfilePhotoButton, requestAction, saveProfileButton, saveProfilePhotoButton, selectProfilePhotoButton, setAppStatus, state, togglePalettePickerButton } from "./core.js";
import { attachmentContentType, createImageCanvas, decodeAttachmentImage, imageProgressMessage } from "./attachments.js";
...
registerCoreHooks({ resetProfileImageCrop });
...
export {
  ...
  decodedImageSize,
  finishProfileCropPointer,
  getActiveProfilePalette,
  moveProfileCrop,
  openProfileEditor,
  renderPalettePicker,
  renderProfileImagePreview,
