...
(function initializeImageProcessing(global) {
  const workerUrl = new URL("../image-worker.js?v=1f252e3cc02d", document.currentScript.src);
  ...
  global.ColorlessImageProcessing = Object.freeze({ cancel, run, supported });
})(window);
