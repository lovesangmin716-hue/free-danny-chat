...
(function initializeIconPlatform(global) {
  ...
  function decorateIconButton(button, name = button?.dataset.icon, options = {}) {
  ...
  global.ColorlessPlatform = Object.freeze({
    ...(global.ColorlessPlatform || {}),
    createIcon,
    decorateIconButton,
    hydrateIcons,
  });
